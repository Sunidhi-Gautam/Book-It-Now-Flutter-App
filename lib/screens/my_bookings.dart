...
//             infoRow(
//                 "💺 Seats",
//                 (booking['seats'] != null && booking['seats'].isNotEmpty)
//                     ? booking['seats'].join(", ")
//                     : "Not selected"),
//             infoRow(
//                 "💰 Paid",
...
//                 ),
//                 // SizedBox(
//                 onPressed: booking['reviewed'] == true
//                     ? null
//                     : () async {
...
//                         if (result == true) {
//                           BookingStore.bookings[bookingIndex]['reviewed'] =
//                               true;
//                           onReviewSubmitted();
              ...
              child: ElevatedButton(
                ...
                onPressed: booking['reviewed'] == true
                    ...
                    : () async {
                        ...
                        if (result == true) {
                          Navigator.pop(context); // Refresh or rebuild bookings
                        }
