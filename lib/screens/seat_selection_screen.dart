...
class _SeatSelectionScreenState extends State<SeatSelectionScreen> {
  ...
  Map<String, String> _parseBookingDetails() {
    ...
    String movieTitle = titleParts.isNotEmpty ? titleParts.first.trim() : widget.movieTitle;
    ...
    // If regex fails, use existing logic as a fallback (less reliable)
      ...
      cinemaDetailsSubtitle = remainingString.replaceAll(RegExp(r'\s*\([^)]*\)'), '').trim();
    ...
    return Container(
      ...
      child: Text(
        ...
        style: const TextStyle(
          ...
          fontSize: 14,
          color: Color.fromARGB(255, 128, 125, 125), // Using a dark color for contrast
        ),
      ),
    );
  }
      ...
      appBar: AppBar(
        title: Column(
          ...
          children: [
            Text(
              movieTitle,
              style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, fontFamily: secondaryFonts),
...
// ...
              ...
              ...buildSectionAndUpdate(
                ...
                cols: 10,
                seatStates: [
                  [SeatState.unselected, SeatState.sold, SeatState.unselected, SeatState.disabled, SeatState.unselected, SeatState.unselected, SeatState.sold, SeatState.unselected, SeatState.unselected, SeatState.unselected],
                  [SeatState.unselected, SeatState.unselected, SeatState.unselected, SeatState.unselected, SeatState.sold, SeatState.unselected, SeatState.unselected, SeatState.unselected, SeatState.disabled, SeatState.unselected],
                  [SeatState.sold, SeatState.sold, SeatState.unselected, SeatState.unselected, SeatState.unselected, SeatState.unselected, SeatState.unselected, SeatState.sold, SeatState.unselected, SeatState.unselected],
                  [SeatState.unselected, SeatState.unselected, SeatState.disabled, SeatState.unselected, SeatState.unselected, SeatState.unselected, SeatState.unselected, SeatState.unselected, SeatState.unselected, SeatState.unselected],
                ],
              ),
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    legendItem('Selected by you', 'assets/images/svg_selected_bus_seats.svg'),
                  ],
                ),
              ),
              const SizedBox(height: 15),
...
class SeatNumber {
  ...
  const SeatNumber({required this.rowI, required this.colI, required this.price});
